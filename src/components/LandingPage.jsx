...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen" style={{
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.p
              ...
              className="text-2xl md:text-3xl text-gray-300 mb-6 max-w-3xl mx-auto"
            >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-full text-lg font-semibold mb-12 shadow-lg hover:shadow-xl transition-shadow"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
            {features.map((feature, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1, duration: 0.6 }}
                viewport={{ once: true }}
                className="relative bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:bg-gray-800/70 transition-all duration-300 group"
              >
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-900/30 to-purple-900/30">
              ...
              <form onSubmit={handleSubscribe} className="max-w-lg mx-auto">
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    required
                    className="flex-1 px-6 py-4 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                  />
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 flex items-center justify-center gap-2 whitespace-nowrap"
                  >
                    {loading ? (
      ...
      <footer className="bg-gray-900/50 border-t border-gray-700 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              <h4 className="text-white text-lg font-semibold mb-6">Planned Features</h4>
            ...
            <div>
              <h4 className="text-white text-lg font-semibold mb-6">Contact & Updates</h4>
